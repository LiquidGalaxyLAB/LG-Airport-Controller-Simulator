...
class _CommandScreenState extends State<CommandScreen> {
  ...
  void initState() {
    ...
    // 👇 Listen for selected plane changes (including deletion)
 ...
 void _handlePlaneDeleted() {
  ...
  void _onClose() { 
    ...
    if((socketService.selectedPlane?['altitude'] == 0  && socketService.selectedPlane?['isnew'])){
    ...
    // socketService.selectPlane(null);
  }

  void _onConfirm() {
    // Send command via socket service
    ...
    print("Command confirmed: ${socketService.commandText}");
      ...
      BottomPopup.showError(context: context, title: 'Error'.tr(), subtitle: 'Please increase altitude before takeoff upto 1000 ft'.tr());
    }
        ...
        child: Column(
          ...
          children: [
           SizedBox(
                ...
                child: Text(
                  command,
                  maxLines: 2, // allow only up to 2 lines
